...
(function (jQuery, undefined) {
    ...
    var handleSpecialPreviews = function (opt) {
        ...
        if (!arr.hasClass("preview4")) {
            ...
            TweenLite.fromTo(raimg_b, 0.8, {force3D: true, x: 0}, {
                x: -raimg.width(), ease: Power3.easeOut, delay: 1, onComplete: function () {
                    raimg.css({'backgroundImage': 'url(' + nextimgsrc + ')'});
                    TweenLite.set(raimg_b, {x: 0});
                }
            });
            TweenLite.fromTo(laimg_b, 0.8, {force3D: true, x: 0}, {
                x: raimg.width(), ease: Power3.easeOut, delay: 1, onComplete: function () {
                    laimg.css({'backgroundImage': 'url(' + previmgsrc + ')'});
            ...
            TweenLite.fromTo(raimg, 0.8, {x: 0}, {
                force3D: true, x: -raimg.width(), ease: Power3.easeOut, delay: 1, onComplete: function () {
                    TweenLite.set(raimg, {x: 0});
                }
            });
            TweenLite.fromTo(laimg, 0.8, {x: 0}, {
                force3D: true, x: raimg.width(), ease: Power3.easeOut, delay: 1, onComplete: function () {
        ...
        if (rar.hasClass("preview4") && !rar.hasClass("hashoveralready")) {
            ...
            lar.hover(function () {
                var iw = jQuery(this).find('.tp-arr-iwrapper');
                var all = jQuery(this).find('.tp-arr-allwrapper');
                TweenLite.fromTo(iw, 0.4, {x: (0 - iw.width())}, {
                    x: 0,
                    delay: 0.3,
                    ease: Power3.easeOut,
                    overwrite: "all"
