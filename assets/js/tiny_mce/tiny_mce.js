(function (d) {
    ...
    var b = {
        majorVersion: "3", minorVersion: "4.9", releaseDate: "2012-02-23", _init: function () {
...
(function (a) {
    a.VK = {
        DELETE: 46, BACKSPACE: 8, ENTER: 13, TAB: 9, SPACEBAR: 32, UP: 38, DOWN: 40, modifierPressed: function (b) {
        ...
        ListBox: function (i, h, f) {
            ...
            e(g.items, function (h) {
                if (h.value === undefined) {
                    f.add({
                        title: h.title, role: "option", "class": "mceMenuItemTitle", onclick: function () {
                            if (g.settings.onselect("") !== false) {
                                g.select("")
                            }
                        }
    ...
    n.create("tinymce.Editor", {
        Editor: function (u, r) {
            ...
            v = o.add(r.iframeContainer, "iframe", {
                ...
                title: J.aria_label,
                style: {width: "100%", height: B, display: "block"}
            });
            ...
            r.formatter.register({
                ...
                link: {
                    inline: "a", selector: "a", remove: "all", split: true, deep: true, onmatch: function (s) {
                        return true
