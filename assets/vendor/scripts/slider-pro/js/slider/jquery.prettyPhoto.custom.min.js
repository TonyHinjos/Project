    ...
    a.fn.prettyPhoto = function (f) {
        function l() {
            ...
            $pp_pic_holder.animate({
                ...
                isSet && p(pp_images[set_position]) == "image" ?
                    $pp_pic_holder.find(".pp_hoverContainer").show() : $pp_pic_holder.find(".pp_hoverContainer").hide();
            ...
            if (isSet && settings.overlay_gallery && p(pp_images[set_position]) == "image" && settings.ie6_fallback && !(a.browser.msie && parseInt(a.browser.version) == 6)) {
                ...
                $pp_gallery.css("margin-left", -(galleryWidth / 2 + navWidth / 2)).find("div:first").width(galleryWidth +
                5).find("ul").width(fullGalleryWidth).find("li.selected").removeClass("selected");
        ...
        function v(b, d) {
            ...
            r = d + detailsHeight;
            w = b;
            k = r + titleHeight + $pp_pic_holder.find(".pp_top").height() +
        ...
        f = jQuery.extend({
            ...
            f);
        var t = this, o = false, c, q, r, w, k, j, g = a(window).height(), h = a(window).width(), n;
        doresize = true;
        scroll_pos = x();
        ...
        a.prettyPhoto.initialize = function () {
            ...
            set_position = jQuery.inArray(a(this).attr("href"),
                pp_images);
        ...
        a.prettyPhoto.open = function (b, d, z) {
            ...
            movie_width = parseFloat(i("width", pp_images[set_position])) ?
                i("width", pp_images[set_position]) : settings.default_width.toString();
            ...
            $pp_pic_holder.fadeIn(function () {
                ...
                "" && typeof pp_titles[set_position] != "undefined" ? $ppt.html(unescape(pp_titles[set_position])) : $ppt.html("&nbsp;");
                imgPreloader = "";
                skipInjection = false;
                switch (p(pp_images[set_position])) {
                    ...
                    case "youtube":
                        ...
                        if (movie_id == "") {
                            ...
                            movie_id = movie_id[1];
                            if (movie_id.indexOf("?") > 0)movie_id = movie_id.substr(0,
                                movie_id.indexOf("?"));
                    ...
                    case "quicktime":
                        ...
                        toInject = settings.quicktime_markup.replace(/{width}/g,
                            c.width).replace(/{height}/g, c.height).replace(/{wmode}/g, settings.wmode).replace(/{path}/g, pp_images[set_position]).replace(/{autoplay}/g, settings.autoplay);
                        break;
                    case "flash":
                        c = e(movie_width, movie_height);
                        ...
                        toInject = settings.flash_markup.replace(/{width}/g, c.width).replace(/{height}/g,
                            c.height).replace(/{wmode}/g, settings.wmode).replace(/{path}/g, filename + "?" + flash_vars);
                        break;
                    case "iframe":
                        c = e(movie_width, movie_height);
        ...
        a.prettyPhoto.startSlideshow = function () {
            if (typeof n == "undefined") {
                ...
                n = setInterval(a.prettyPhoto.startSlideshow,
                    settings.slideshow)
        ...
        a.prettyPhoto.close = function () {
            if (!$pp_overlay.is(":animated")) {
                ...
                a("div.pp_pic_holder,div.ppt,.pp_fade").fadeOut(settings.animation_speed,
                    function () {
                        a(this).remove()
                    });
