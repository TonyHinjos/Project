...
<head>
    ...
    <script type="" src="<?php base_url(); ?>assets/user/js/uploader.js"></script>
     ...
     <!-- Datatables-->
      <script src="<?php base_url(); ?>assets/user/datatable/jquery.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/dataTables_002.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/dataTables_003.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/buttons.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/jszip.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/pdfmake.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/vfs_fonts.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/buttons_002.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/buttons_003.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/dataTables_005.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/dataTables.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/dataTables_006.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/responsive.js"></script>
      <script src="<?php base_url(); ?>assets/user/datatable/dataTables_004.js"></script>
      ...
      <script src="<?php base_url(); ?>assets/user/datatable/datatables.js"></script>
       ...
       <link rel="stylesheet" type="text/css" href="<?php base_url(); ?>assets/user/datatable/css/jquery.dataTables.css">
...
<div class="row">
    ...
    <div class="col-xs-6 col-sm-6 right">
      <a style="margin-left:500px" href="<?php echo(base_url()); ?>user_dashboard/make_application" class="pull-right btn btn-success waves-effect w-md waves-light">Make Applicaiton</a>
    </div>
</div>
<!-- Page-Title -->
    ...
    <div class="col-lg-12">
        <div class="card-box">
               ...
               <table id="example" class="display" cellspacing="0" width="100%">
                <thead>
                    <tr role="row">
                    <th aria-controls="datatable-responsive" tabindex="0" class="sorting" >Form</th>
                     <th aria-controls="datatable-responsive" tabindex="0" class="sorting" >Ref No</th>
                     <th aria-controls="datatable-responsive" tabindex="0" class="sorting" >Bill Status</th>
                     <th aria-controls="datatable-responsive" tabindex="0" class="sorting">Approval</th>
                     <th aria-controls="datatable-responsive" tabindex="0" class="sorting">Submitted On</th>
                     <th aria-controls="datatable-responsive" tabindex="0" class="sorting">Actions</th>
                    </tr>
                </thead>

                <tbody>
                <?php foreach ($applications as $apps): ?>
                    <tr role="row" class="unread">
        <td>
         Official Land Search- Leasehold/Freehold
            </td>
      <td>
          <a href="<?php echo (base_url()); ?>view_entry/index/<?=$apps->user_search_id?>/<?=$apps->title_number?>">Draft-<?=$apps->date;?></a>
      </td>
      <td>
      ...
      <td>
       <?php
        $php_timestamp=strtotime($apps->date);
      ...
      <div class="btn-group">
          <button type="button" class="btn btn-xs btn-default dropdown-toggle waves-effect waves-light" data-toggle="dropdown" aria-expanded="false">Action <span class="caret"></span></button>
          <ul class="dropdown-menu dropdown-menu-right" role="menu">

          <li><a title="View Application" href="<?php echo (base_url()); ?>view_entry/index/<?=$apps->user_search_id?>/<?=$apps->title_number?>">View</a></li>
                        <li><a title="Edit Application" href="<?php echo (base_url()); ?>user_search/edit/<?=$apps->user_search_id?>/<?=$apps->title_number?>">Edit </a>
              </li>
                                    <li><a title="View Invoices" href="<?php echo (base_url()); ?>print_invoice/index/<?=$apps->user_search_id?>/<?=$apps->title_number?>">Print Invoice</a></li>
                    </ul>
    </div>
      </td>
</tr><?php endforeach; ?>
