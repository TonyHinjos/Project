...
<?php foreach ($search as $search_review): ?>

<tr>

<td style="color:#6CBE42;line-height:50px;" class="mf_review_label" width="40%">Land Title Number</td>
<td style="color:#6CBE42;"class="mf_review_value" width="60%"><?=$search_review->title_number;?></td>
</tr>

<tr class="alt">
<td style="color:#6CBE42;line-height:50px;" class="mf_review_label" width="40%">Land Parcel Number</td>

<td style="color:#6CBE42;"class="mf_review_value" width="60%"><?=$search_review->parcel_number;?></td>
</tr>

<tr>
<td style="color:#6CBE42;line-height:50px;" class="mf_review_label" width="40%">Purpose of the Search</td>
<td style="color:#6CBE42;" class="mf_review_value" width="60%"><?=$search_review->purpose;?></td>
</tr>
<tr>
 <td  id="li_buttons">
