...
<nav class="navbar navbar-default navbar-fixed-top ecitizen" id="subnav">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xs-5 user-links">
                        Welcome to LandGIS | <a href="<?php base_url(); ?>login/user_login">Login</a> | <a
                            href="<?php base_url(); ?>login/user_role">Register</a></div>

                    <div class="col-xs-7 top-links">
                        <a href="<?php base_url(); ?>login/user_login">My Account</a> |
                        <a href="<?php base_url(); ?>login/contact_us">Contact us</a>
        ...
        <div id="header">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5">
                    <span class="listing-add"><a href="<?php base_url(); ?>login/user_role"><span
                                class="glyphicon glyphicon-plus-sign"></span>Create Account</a></span>
                        </br>
                        <span><a style="font-size:15px;font-weight: 700"class="pull-right link-button " href="<?php base_url(); ?>login/user_login"> Login</a></span>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container  portal-trio">
        <div style="text-align:center" class="row">
            <a style="font-size:15px;font-weight: 700;padding-top: 6px;padding-bottom: 6px" class="col-sm-3 col-xs-3 landgis" title="landgis"
               onclick="window.open('pop.html','popup','height=250,width=350,scrollbars=no'); return(false);"
    ...
    <ul>
        <li class="slide-1">
            <div class="container">
                ...
                <span style="margin-right:550px;font-size: 15px" class="listing-add"><a href="<?php base_url(); ?>login/user_role"><span
                            class="glyphicon glyphicon-plus-sign"></span>Create Account</a></span>
                </h1>
            </div>
        </li>
        <li class="slide-2">
            <div class="container">
                ...
                <span style="margin-right:750px;font-size: 15px" class="listing-add"><a href="<?php base_url(); ?>login/user_role"><span
                            class="glyphicon glyphicon-plus-sign"></span>Create Account</a></span>
                </h1>
...
<section class="container">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            autoSuggestion('property_name_box', "/Property/frontend/searchname", {'property_name': ''}, ['property_primary_image', 'property_image', 'property_name', 'property_name', 'owner_name', 'property_room', 'property_location', 'state_name'], 'data/frontImages/property/property_image', 2);
            autoSuggestion('post_code_box', "/Property/frontend/searchname", {'post_code': ''}, ['property_primary_image', 'property_image', 'property_name', 'post_code', 'owner_name', 'property_postcode', 'property_location'], 'data/frontImages/property/property_image', 2);
            autoSuggestion('property_price_box', "/Property/frontend/searchname", {'property_price': ''}, ['property_primary_image', 'property_image', 'property_name', 'price', 'owner_name', 'property_price', 'property_location'], 'data/frontImages/property/property_image', 2);
            autoSuggestion('area_id_block', "/Property/frontend/city", {
                'city': '',
                'limit': '10',
                'order': 'ASC',
                'order_sort': 'city'
            }, ['city_id', 'city_id', 'city', 'city_value'], '', 1);
    ...
    <div class="row">
        ...
        <div class="container">
            ...
            <div class="aq-block aq-block-pg_button_block col-md-12 col-xs-12 clearfix" id="aq-block-12-6">
                <a target="" href="<?php base_url(); ?>login/user_role">
