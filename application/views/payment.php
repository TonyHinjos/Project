                ...
                <div>
                    <div>
                        ...
                        <ul class="m-l-0">
                            ...
                            <li><a target="_blank" href=""> Buy Land Deedplan</a></li>
                            <li><a target="_blank" href="">GIS Location</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<iframe name="iframe" scrolling="no" frameborder="0" height="900px" width="100%">
&lt;p&gt;Browser unable to load iFrame&lt;/p&gt; </iframe>
<form id="details" method="post" action="https://pesaflow.ecitizen.go.ke/PaymentAPI/iframev2.php?" target="iframe">
<input name="apiClientID" value="1" type="hidden">
<input name="key" value="6678979C75A70BDA85762F4D488AFB6F" type="hidden">
<input name="secret" value="wyDjxWr9A1SX850KtMn" type="hidden">
<input name="currency" value="KES" type="hidden">
<input name="billDesc" value="Name Search - Company / Business" type="hidden">
<input name="billRefNumber" value="463/44488/55559" type="hidden">
<input name="serviceID" value="19" type="hidden">
<input name="clientMSISDN" value="+254721567977" type="hidden">
<input name="clientName" value="ANTHONY WANJOHI MURIUKI" type="hidden">
<input name="clientEmail" value="awanjohim@gmail.com" type="hidden">
<input name="clientIDNumber" value="29207541" type="hidden">
<input name="clientType" value="citizen" type="hidden">
<input name="amountExpected" value="150" type="hidden">
<input name="callBackURLOnSuccess" value="http://ag.ecitizen.go.ke/index.php/forms/confirmpayment?id=463&amp;entryid=44488&amp;done=1&amp;invoiceid=55559&amp;status=201" type="hidden">
<input name="callBackURLOnFail" value="http://ag.ecitizen.go.ke/index.php/forms/invalidpayment" type="hidden">
<input name="notificationURL" value="http://ag.ecitizen.go.ke/index.php/payment/updateinvoice" type="hidden">
</form>
<script> document.getElementById("details").submit(); </script>    </div>
</div>
