...
<div class="container-fluid">
    ...
    <ul class="sky-mega-menu sky-mega-menu-response-to-icons sky-mega-menu-anim-scale">
        ...
        <li>
            ...
            <div class="grid-container3">
                <ul>
                    <li><a href="<?php echo(base_url()); ?>gis_view" class="" target="_blank"><i
                    ...
                    <div class="col-md-6 col-xs-6">
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9">
                                <p>
                                    User Profile<br>
                                    User Name : user@landgis.com<br>
                                    Email : user@landgis.com<br>
                                    Payment Gateway: paypal.com<br>
                                    Last Login : Sunday, March 28, 2016 4:48:21 AM<br>
                                </p>
        ...
        <div id="">
            ...
            <div class="mod">
                <div class="search-icon">
                    <h1> Official Land Search Form</h1>
                </div>
...
<select name="title" id="title" title="Enter Title" size="1" class="form-control" admin="1"
    ...
    <option value="1">Freehold TitleDeed.</option>
    <option value="2">Leasehold TitleDeed</option>
                                ...
                                <div class="form-label-container">
                                    <div class="label_class label_class" style="">
                                        Enter Title No:<span class="star_class star_class" style="">*</span>&nbsp;
                                    </div>
                                </div>
                                ...
                                <div class="form-field-container">
                                    <div class="form-field">
                                              <span class="ui-widget">
<input type="text" name="firstName" id="firstName" value="" size="35" title="Enter Title No" class="form-control"
       admin="1" frontend="1"></span><br/>
                                ...
                                <div class="form-label-container">
                                    <div class="label_class label_class" style="">
                                        Enter Parcel No:<span class="star_class star_class" style="">*</span>&nbsp;
                                    </div>
                                </div>
                                ...
                                <div class="form-field-container">
                                    <div class="form-field">
                                              <span class="ui-widget">
<input type="text" name="lastName" id="lastName" value="" size="35" title="Enter Parcel No" class="form-control"
       admin="1" frontend="1"></span><br/>
                        ...
                        <fieldset>
                            ...
                            <div>
                                ...
                                <div class="form-label-container">
                                    <div class="label_class label_class" style="">
                                        Purpose of Search:<span class="star_class star_class" style="">*</span>&nbsp;
                                    </div>
                                </div>
                                ...
                                <div class="form-field-container">
                                    <div class="form-field">
                                              <span class="ui-widget">
<textarea name="address" id="address" title="Please Type your Purpose" cols="30" rows="3" class="editor form-control"
          admin="1" frontend="1"></textarea></span><br/>
                                ...
                                <div class="form-label-container">
                                    <div class="label_class label_class" style="">
                                        Name of AdvocateAgent:<span class="star_class star_class" style="">*</span>&nbsp;
                                    </div>
                                </div>
                                ...
                                <div class="form-field-container">
                                    <div class="form-field">
                                              <span class="ui-widget">
<textarea name="address" id="address" title="Please type your particulars" cols="30" rows="3" class="editor form-control"
          admin="1" frontend="1"></textarea></span><br/>
                                        <span class="input-errors" id="address_err"></span>
                                    </div>
                                    <div class="form-field-info"></div>
