                        ...
                        <div class="row">
                            ...
                            <div class="col-md-10 col-xs-9">
                                <p>
                                    ...
                                    Last Login : Sunday, February 28, 2016 4:48:21 AM<br>
                                </p>
                                <a href=""
                    ...
                    <div class="row">
                            ...
                            <div class="panel-group" id="accordion-test-2">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion-test-2"
                                               href="#collapseTwo-1" class="collapsed" aria-expanded="false">
                                                OFFICIAL LAND SEARCH - LEASEHOLD/FREEHOLD </a>
                                        </h4>
                                    </div>
                                        ...
                                        <div class="panel-body">
                                            <ul class="list-group list-group-forms m-b-0">
                                                <li class="list-group-item">
                                                    <a href="<?php echo(base_url()); ?>user_dashboard/instructions">Official
                                                        land search- leasehold/ freehold</a>
                                                </li>
                                                <ul>
                                                </ul>
                                            </ul>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion-test-2"
                                               href="#collapseTwo-2" class="collapsed" aria-expanded="false">
                                                BUY LAND MAPS </a>
                                        </h4>
                                    </div>
                                    <div id="collapseTwo-2" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ul class="list-group list-group-forms m-b-0">
                                                <li class="list-group-item">
                                                    <a href="">1. Buy land map</a>
                                                </li>
                                                <li class="list-group-item">
                                                    <a href="">2. Buy land Deed Plan</a>
                                                </li>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            <a data-toggle="collapse" data-parent="#accordion-test-2"
                                               href="#collapseTwo-3" class="collapsed" aria-expanded="false">
                                                EXACT LAND LOCATION </a>
                                        </h4>
                                    </div>
                                    <div id="collapseTwo-3" class="panel-collapse collapse">
                                        <div class="panel-body">
                                            <ul class="list-group list-group-forms m-b-0">
                                                <li class="list-group-item">
                                                    <a href="<?php echo(base_url()); ?>gis_view">1.land GIS location</a>
                                                </li>
                                                <ul>
                                                </ul>
                                            </ul>
                     ...
                     <div id="collapseTwo-4" class="panel-collapse collapse">
                         <div class="panel-body">
                             <ul class="list-group list-group-forms m-b-0">
                                                                     <li class="list-group-item">
                                         <a href="https://ag.ecitizen.go.ke/index.php/forms/info?id=16125">Business / Company Lost / Information Correction</a>
                                     </li>
                                                                     <ul>
                         </ul></ul></div>
                     </div>
