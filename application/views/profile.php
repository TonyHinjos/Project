            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <form class="m-t" role="form" method="post"
                          action="<?php echo base_url(); ?>profile/farmer_edit_account">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="other_names" value="<?php echo($user->other_names); ?>"
                                   class="form-control" placeholder="Other names" required="">
                        </div>
                        <div class="form-group">
